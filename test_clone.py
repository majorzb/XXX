...
class MainWin(QMainWindow, Ui_MainWindow):
    ...
    def display_page1(self):
        ...
        self.frame.setStyleSheet("QFrame#frame{\n"
                                 "background-color:qlineargradient(x1:0,y0:1,x1:0,y1:1,stop:0 rgb(147,164,173), stop:1 rgb(241,242,241));\n"
                                 "border-radius:18px;}")
    ...
    def display_page2(self):
        ...
        self.pushButton_7.setStyleSheet("QPushButton{\n"
                                        ...
                                        "            }")
        self.frame.setStyleSheet("QFrame#frame{\n"
                                 "background-color:qlineargradient(x1:0,y0:1,x1:0,y1:1,stop:0 rgb(193,191,241), stop:1 rgb(147,146,215));\n"
                                 "border-radius:18px;}")
    ...
    def display_page4(self):
        ...
        self.pushButton_7.setStyleSheet("QPushButton{\n"
                                        ...
                                        "            }")
        self.frame.setStyleSheet("QFrame#frame{\n"
                                 "    background-color:qlineargradient(x1:0,y0:1,x1:0,y1:1,stop:0 rgb(184,204,229), stop:1 rgb(248,248,250));\n"
                                 "border-radius:18px;}")
    ...
    def tox_21(self):
        ...
        if molecule:
            ...
            labels = ['NR-AR(雄激素受体α，LBD活性):',
                      'NR-AR-LBD(雄激素受体α，full活性):',
                      'NR-AhR(芳香烃受体活性):',
                      'NR-Aromatase(芳香化酶活性):',
                      'NR-ER(雌激素受体α，full活性):',
                      'NR-ER-LBD(雌激素受体α，LBD活性):',
                      'NR-PPAR-gamma(过氧化物酶体增殖物激活受体活性):',
                      'SR-ARE(核因子(红细胞衍生2)样2/抗氧化反应元件活性):',
                      'SR-ATAD5(ATAD5核酸交联修复相关的ATP酶活性起动剂激活活性):',
                      'SR-HSE(热休克响应元件活性):',
                      'SR-MMP(线粒体膜电位活性):',
                      'SR-p53(肿瘤蛋白p53活性):']
